<template lang="">
    <div class="h-full w-full hidden lg:block">
        <div
            class="w-full h-full bg-primary text-white flex flex-col items-center justify-center px-4 pb-6"
        >
            <div class="pb-6">
                <HomeNavigationProfileImage></HomeNavigationProfileImage>
            </div>
        ...
        <div class="w-full flex justify-end items-center px-2 py-2">
            ...
            >
                <template #container="{ closeCallback }">
                    <div
                        class="bg-primary flex flex-col items-start w-full px-2 py-2"
                    >
...
function handleScroll(event: Event) {
    ...
    for (let item of menu.value) {
        ...
        if (
            scrollY >= itemOffsetTop - 200 &&
            scrollY < itemOffsetTop + itemScrollHeight
        ) {
            target = item
        }
    }
